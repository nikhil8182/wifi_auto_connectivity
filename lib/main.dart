...
//                   setState(() {
//                     //ignore:avoid_print
//                     print("im inisde the state of is connected _____________---");
//                     _isConnected = val;
//                     //ignore:avoid_print
//                     print("$_isConnected");
//                   });
//                 });
//
//                 //WiFiForIoTPlugin.connect("onwords");
//                // WiFiForIoTPlugin.onWifiScanResultReady;
//                //  //ignore:avoid_print
//                //  print("66666666666666666666666 ${WiFiForIoTPlugin.onWifiScanResultReady}");
//               });
...
// wifi connectivity example method
// how  automatically connect wifi when app is turned on
...
class _MyAppState extends State<MyApp> {
  ...
  @override
  void initState() {
    // SimplyWifi.turnOnWifi().then((value){
    //   //ignore:avoid_print
    //   print("im inisde so fuck");
    // });
              ...
              ElevatedButton(
                onPressed: (){
                  setState(() {
                    //ignore:avoid_print
                    print("button is pressed");
                    SimplyWifi.turnOffWifi().then((value){
                      //ignore:avoid_print
                      print("im outside so suck");
                    });
                  });
                },
                child: Text(" ||||||||||| "),
